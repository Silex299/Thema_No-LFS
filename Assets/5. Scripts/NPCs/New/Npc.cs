...
namespace NPCs.New
{
    public class Npc : MonoBehaviour
    {
        ...
        [FoldoutGroup("Idle")] public NpcStates initState = NpcStates.Serveillance;
        [FoldoutGroup("Idle")] public String entryAnim;
        ...
        [FoldoutGroup("Chase"), ShowIf(nameof(returnToServeillanceOnTargetLost))]
